              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            LoginPage()), // This remains unchanged
                  );
                },
                style: ElevatedButton.styleFrom(
                  padding: const EdgeInsets.symmetric(
                      horizontal: 40,
                      vertical: 10), // Adjusted padding for a larger button
                  ...
                  backgroundColor: const Color.fromRGBO(
                      157, 220, 250, 1), // Custom background color
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const user_signin()), // This remains unchanged
                  );
                },
                style: ElevatedButton.styleFrom(
                  padding: const EdgeInsets.symmetric(
